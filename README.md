...
A purpose-built, single-server SSH tunnel with a local **SOCKS5** and **HTTP** proxy,
written in Go with a native Fyne GUI (Linux/GNOME).
...
![Cipher Proxy GUI](assets/cipher-proxy-screenshot.png)
